...
const LoginScreen = ({ navigation }) => {
  ...
  const handleGuestLogin = async () => {
    try {
      ...
      console.error('Error setting guest login:', error);
        ...
        >
          <View style={styles.content}>
            ...
            <View style={styles.formSection}>
              ...
              <Text style={styles.subText2}>Find out what benefits you qualify for in just 60 seconds — fast, free, and secure.
...
const styles = StyleSheet.create({
  ...
  inputContainer: { marginBottom: height * 0.025 },
  label: {
  ...
  registerText: { fontSize: Math.min(16, width * 0.04), color: '#999' },
  registerLink: {
    fontSize: Math.min(16, width * 0.04),
    color: 'white',
    fontWeight: '600',
